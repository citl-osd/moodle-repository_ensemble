...
$string['serviceUserHelp']  = '<div>The Ensemble Video service account username. Note: Do not include authentication domain here. Use the field below.</div>';
...
$string['authDomainHelp']   = '<div>(Optional) Authentication domain used when logging in to Ensemble Video.</div>';
